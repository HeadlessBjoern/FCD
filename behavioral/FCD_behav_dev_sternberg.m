%% Visualization of behavioral data for FCD Sternberg
...
set(gca, 'YLim', [min(dataAcc(:)) * 0.9 102]);
...
% Save the plot
saveas(gcf, '/Volumes/methlab/Students/Arne/FCD/figures/behavioral/FCD_acc_sternberg_boxplot.png');

% Stats
means = mean(dataAcc, 'omitnan');
stds = std(dataAcc, 'omitnan');
save /Volumes/methlab/Students/Arne/FCD/data/features/accuracy means stds
...
% Save the plot
saveas(gcf, '/Volumes/methlab/Students/Arne/FCD/figures/behavioral/FCD_rt_sternberg_boxplot.png');

% Stats
means = mean(dataRT, 'omitnan');
stds = std(dataRT, 'omitnan');
save /Volumes/methlab/Students/Arne/FCD/data/features/RTs means stds
